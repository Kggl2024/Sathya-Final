          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 mb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-gradient-to-r from-emerald-300 to-[#1e7a67] rounded-xl shadow-lg">
              ...
              <button
                ...
                className="group bg-gradient-to-r from-emerald-500 to-[#1e7a67] text-white px-6 py-3 rounded-xl hover:from-emerald-700 hover:to-[#1e7a67] transition-all duration-200 text-sm sm:text-base focus:outline-none focus:ring-4 focus:ring-blue-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center gap-2 font-medium"
              >
                        ...
                        <React.Fragment key={client.company_id}>
                          ...
                          >
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-2">
                                <div className="w-8 h-8 flex items-center justify-center text-[#1e7a67] font-semibold text-sm">
                                  {client.company_id}
                                </div>
                              </div>
                            </td>
            ...
            <div className="mt-6 bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
              <div className="flex items-center justify-between text-sm text-slate-600">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-[#1e7a6f] rounded-full"></div>
