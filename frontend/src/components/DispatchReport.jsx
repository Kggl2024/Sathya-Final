  ...
  //           // Parse dispatch_date to Date (handles "Sep 25, 2025" format)
  ...
  //               <tbody>
  //                 <tr>
  //                   <td colSpan={15} className="returnable-note">
  ...
  //           }
  //           .header-table, .materials-table, .footer-table {
  //             width: 100%;
  ...
  const renderMaterialsTable = (materialsChunk, pageIndex) => (
    <table className="materials-table">
      ...
      <tbody>
        ...
        {/* Add empty rows to maintain consistent 5 rows per page */}
        {materialsChunk.length < materialsPerPage && 
          Array.from({ length: materialsPerPage - materialsChunk.length }).map((_, index) => (
            <tr key={`empty-${index}`}>
              <td className="cell-center">{materialsChunk.length + index + 1}</td>
              <td className="cell-left">&nbsp;</td>
              <td className="cell-left-bold">&nbsp;</td>
              <td className="cell-left">&nbsp;</td>
              <td className="cell-left">&nbsp;</td>
            </tr>
          ))
